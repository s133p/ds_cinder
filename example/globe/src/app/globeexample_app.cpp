...
GlobeExample::GlobeExample()
	: inherited(ds::RootList()
								...
								.perspFov(30.0f)
								.perspPosition(glm::vec3(0.0, 0.0f, 2080.0f))
...
void GlobeExample::moveCamera(const glm::vec3& deltaMove){
	ds::PerspCameraParams p = mEngine.getPerspectiveCamera(0);
